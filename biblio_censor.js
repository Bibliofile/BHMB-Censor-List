...
(function(ex) {
    ...
    ex.tab.innerHTML = '<style>#biblio_censor textarea{overflow: hidden; min-height: 30px; resize: none; width: 100%;}#biblio_censor input{width: 100%;}</style><div id="biblio_censor"> <h3>Censoring</h3> <p>When any of the words in the list below are said, say</p><input> <p>Messages from staff will not be checked.</p><hr> <p>One word per line, if you put the word "doodle" and someone says "d&oslash;odle", it will be caught.</p><textarea></textarea></div>';
